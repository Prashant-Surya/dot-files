...
gg() {
    ...
    git grep -E --heading -n --ignore-case ${1+"$@"}
}
...
export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:~/arcanist/bin/
...
export PS1="\[${COLOR_CYAN}\]\u@\h:\w\[${COLOR_WHITE}\]\$(
parse_git_branch)\[${COLOR_NC}\]\n\$ "
...
# powerline for bashrc
#if [ -f /usr/local/lib/python2.7/dist-packages/powerline/bindings/bash/powerline.sh ]; then
#    source /usr/local/lib/python2.7/dist-packages/powerline/bindings/bash/powerline.sh
#fi

# ssh passphrase online once
